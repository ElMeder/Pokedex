...
# Obtener información de los primeros 151 Pokémon y mostrar solo los de tipo "Flying" con altura mayor a 1 metro
for numero in range(1, 152):
    datos = obtener_pokemon(numero)
    if datos:
        tipos = datos[2]  # Extraer la cadena de tipos del Pokémon
        altura = float(datos[3].split()[0])  # Extraer el valor numérico de la altura en metros
        if "Flying" in tipos and altura > 1:  # Verificar tipo "Flying" y altura mayor a 1 metro
