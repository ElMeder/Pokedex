...
def obtener_pokemon(numero):
    ...
    if respuesta.status_code == 200:
        ...
        # Invertir el nombre del Pokémon
        nombre_invertido = nombre[::-1]
        # Devolver los datos del Pokémon en una tupla
        return (numero, nombre, nombre_invertido, tipos, altura, peso)
    else:
...
tv = ttk.Treeview(Ventana_principal, columns=("col0", "col1", "col2", "col3", "col4", "col5"))

# Configurar las columnas de la tabla
tv.column("#0", width=0)
tv.column("col0", width=150, anchor=CENTER)
...
tv.column("col5", width=150, anchor=CENTER)

# Configurar las cabeceras de las columnas
tv.heading("col0", text="ID", anchor=CENTER)
tv.heading("col1", text="Nombre", anchor=CENTER)
tv.heading("col2", text="Nombre Invertido", anchor=CENTER)
tv.heading("col3", text="Tipo(s)", anchor=CENTER)
tv.heading("col4", text="Altura", anchor=CENTER)
tv.heading("col5", text="Peso", anchor=CENTER)

# Obtener información de los primeros 50 Pokémon y mostrarla en la tabla
